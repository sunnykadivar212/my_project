...
import { StyleSheet, TextInput, View, Text, Button, TouchableHighlight, ToastAndroid, Image } from "react-native";
            ...
            <View style={styles.main}>
                <View style={styles.container}>
                    ...
                    <View>
                        ...
                        <Text style={{ color: 'black', textAlign: 'center', fontSize: 18, margin: 10, fontWeight: "500" }}>Complete your registraion</Text>
                        <View style={styles.view}>
                            <TextInput
                                placeholder="Email"
