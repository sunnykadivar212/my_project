            ...
            <View style={styles.main}>
                <View style={styles.container}>
                    ...
                    <View>
                        ...
                        <View style={styles.icon}>
                            <TouchableOpacity style={{ flexDirection: 'row' }} onPress={togglePasswordVisibility}>
                                <Icon name={showPassword ? 'eye' : 'eye-slash'} size={20} color='black' />
                                <Text style={{ color: 'black', paddingLeft: 5 }}>Show Password</Text>
                            </TouchableOpacity>
                        </View>
                        ...
                        <TouchableOpacity onPress={Forgotpassword} style={{ alignItems: 'center' }}>
                            <Text style={{
                                fontSize: 18,
                                textAlign: 'center',
                ...
                <View style={styles.childView}>
                    <TouchableOpacity onPress={() => navigation.navigate("signUpPage")}>
                        <Text style={{ color: 'black', textAlign: 'center' }}>Register a new account here!</Text>
                    </TouchableOpacity>
